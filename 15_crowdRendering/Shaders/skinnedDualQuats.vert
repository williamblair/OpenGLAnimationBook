...
uniform mat2x4 pose[120];           // Dual Quaternions
...
void main() {
    ...
    // neighborhood all of the quaternions
    ...
    // multiply position by the skin dual quaternion
    vec4 v = transformPoint(skinDq, position);

    gl_Position = projection * view * model * v; 
    fragPos = vec3(model * v);

    // multiply normal by the skin dual quaternion
